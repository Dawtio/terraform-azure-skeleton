...
# variable "as_enforce_private_link_endpoint_network_policies" {
#   description = "Enable or Disable network policies for the private link endpoint on the subnet."
#   type        = bool
#   default     = false
# }

# variable "as_enforce_private_link_service_network_policies" {
#   description = "Enable or Disable network policies for the private link service on the subnet."
#   type        = bool
#   default     = false
# }

# variable "as_service_endpoints" {
#   description = "The list of Service endpoints to associate with the subnet."
#   type        = list(string)
#   default     = null

#   validation {
#     condition = var.as_service_endpoints == null || can([
#       for o in var.as_service_endpoints : contains(["Microsoft.AzureActiveDirectory", "Microsoft.AzureCosmosDB", "Microsoft.ContainerRegistry", "Microsoft.EventHub", "Microsoft.KeyVault", "Microsoft.ServiceBus", "Microsoft.Sql", "Microsoft.Storage", "Microsoft.Web"], o)
#     ])
#     error_message = "The variable as_service_endpoints must be at least one of Microsoft.AzureActiveDirectory, Microsoft.AzureCosmosDB, Microsoft.ContainerRegistry, Microsoft.EventHub, Microsoft.KeyVault, Microsoft.ServiceBus, Microsoft.Sql, Microsoft.Storage and Microsoft.Web."
#   }
# }

# variable "as_service_endpoint_policy_ids" {
